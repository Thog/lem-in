...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2016/11/16 08:55:06 by tguillem          #+#    #+#             */
/*   Updated: 2016/11/16 09:15:20 by tguillem         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int							compute_connections(t_array **map,
		t_graph **graph);
int							check_command(t_array **map, t_graph **graph);
int							is_connection_availaible(t_graph *first,
		t_graph *sec);
...
t_path						*move_ant(t_data *data, t_path *paths,
		t_path *move);
